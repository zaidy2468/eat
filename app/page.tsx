  ...
  return (
    <>
      <div className=" relative w-full h-full  ">
        ...
        >
          <div className="flex p-[4rem] items-center justify-between">
            <div className="">
              <img src="https://eat-curious.com/wp-content/uploads/2022/12/home-4.svg" />
            </div>
            <div className="flex-wrap text-white">
              <h3 className="font-bold tracking-tighter text-[70px]">
                FLAVOURSOME FOOD
                <br /> FOR EVERYONE
              </h3>
              <p className="tracking-tighter text-[20px]">
        ...
        <div
          className={`bg-red-500  w-full h-[810px] overflow-hidden ${
          ...
          <div className="flex p-[4rem] items-center justify-between">
            ...
            <div className="flex-wrap">
              ...
              <p className="tracking-tighter text-[20px]">
                ...
                <br />
                eat more plants.Because we care about the future-
                <br />
                yours,ours and the planets
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-green-950 relative w-full ">
            <nav>
              <ul className="text-white flex justify-between items-center">
                <div className="flex p-12 space-x-[12rem] font-bold tracking-tighter mx-20 md:flex lg:flex sm:hidden">
                  <div>
                    <li>ABOUT</li>
                  </div>
                  <div>
                  ...
                  <div className=" bg-pink-400 rounded flex  text-green-900 font-black justify-center items-center">
                    <li className="p-2 tracking-tighter  ">CONTACT US</li>
                  </div>
                </div>
              </ul>
            </nav>
            <div className="text-white flex font-black text-[12rem] h-[14rem] tracking-tighter px-[16rem] absolute uppercase ">
              <div className="">MEAT</div>
              <span>-</span>
              <div>FREE</div>
            </div>
            <div className="w-[22rem] mx-[38rem] mt-[11rem]  ">
              <img
...
"
            ...
            <div className="text-white flex font-black text-[12rem] tracking-tighter px-[16rem] mt-[-9rem]">
              <div>YOUR</div>
          ...
          >
            <div className="flex-wrap">
              ...
              <p className="tracking-tighter">
                ...
                together, tear, shake, and break the rules –<br /> on a mission
      ...
      <div className="relative bg-white-500 top-[288rem] flex flex-col items-center gap-[5rem] mt-[3rem]">
        ...
        />
        <button className="absolute bg-pink-400 tracking-tighter font-extra-bold mt-[10rem] rounded-lg text-[25px]"><p className="p-2">LET'S CHAT</p></button>
      </div>
    </>
  );
}
